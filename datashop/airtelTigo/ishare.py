...
def send_ishare_bundle(request, client_ref, phone_number, bundle, username, email, user_phone, first_name, last_name):
    ...
    if ref_needed == client_ref and status_needed == "Success":
        ...
        if payment:
            ...
            headers = {
                'Authorization': "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI0YjJkOWE5Zi04OTQ0LTRhYTItYTAxYy01NmNlNTdmZWUwYmEiLCJhdXRob3JpdGllcyI6W3siYXV0aG9yaXR5IjoiUk9MRV9BRE1JTiJ9XSwiaWF0IjoxNjc3MTk4MTE5LCJleHAiOjE2NzcyODMyMDB9.oo7KNyfUdfco-yhVL6GO5RS2L4XtOOoCgTMg7zrjtUhEz7ddR-5n-lRyV_JbOVxn0ddDsVG4NsdeoMUUgz_COQ",
                'Content-Type': 'application/json'
            }
            ...
            if response.status_code == 200:
                ...
                sms_url = f"https://sms.arkesel.com/sms/api?action=send-sms&api_key=UmpEc1JzeFV4cERKTWxUWktqZEs&to={user_phone}&from=BestPay&sms={sms_message}"
